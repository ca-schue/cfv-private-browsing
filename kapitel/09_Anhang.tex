...
\begin{table}[h!]
\centering
\caption{Veränderte Firefox SQLite-Datenbanken und deren Verwendungszwecke}
...
\begin{table}[h!]
\centering
\caption{Veränderung der Tor-Browser SQLite-Datenbanken während der Versuchsdurchführung}
...
\begin{table}[h!]
%	\centering
	\caption{Chrome alle ``WriteFile``-Operationen des Logfiles 1}
...
%\afterpage{
	\begin{landscape}% Landscape page
		...
		\begin{table}[h!]
			%	\centering
			\caption{Chrome alle ``WriteFile``-Operationen des Logfiles 2}
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		History                  & \cellcolor[HTML]{FFCE93}\begin{tabular}[c]{@{}c@{}}Initialisiert \\ (Nur Spaltennamen)\end{tabular} & \cellcolor[HTML]{FE996B}keine Veränderung                                                                       & \cellcolor[HTML]{9AFF99}\begin{tabular}[c]{@{}c@{}}Datensätze \\ hinzugekommen,\\  keine Artefakte\end{tabular} & \cellcolor[HTML]{FD6864}Datensatz gelöscht                                                                   \\ \hline
		...
		Shortcuts                & \cellcolor[HTML]{C0C0C0}N/A                                                                         & \cellcolor[HTML]{FFCE93}\begin{tabular}[c]{@{}c@{}}Initialisiert \\ (Nur Spaltennamen)\end{tabular}             & \cellcolor[HTML]{FE996B}keine Veränderung                                                                       & \cellcolor[HTML]{FE0000}\begin{tabular}[c]{@{}c@{}}Datenbank gelöscht / \\ nicht mehr vorhanden\end{tabular} \\ \hline
		...
		Network Action Predictor & \cellcolor[HTML]{C0C0C0}N/A                                                                         & \cellcolor[HTML]{FFCE93}\begin{tabular}[c]{@{}c@{}}Initialisiert \\ (Nur Spaltennamen)\end{tabular}             & \cellcolor[HTML]{FE996B}keine Veränderung                                                                       & \cellcolor[HTML]{FE0000}\begin{tabular}[c]{@{}c@{}}Datenbank gelöscht / \\ nicht mehr vorhanden\end{tabular} \\ \hline
		Reporting and NEL        & \cellcolor[HTML]{FFCE93}\begin{tabular}[c]{@{}c@{}}Initialisiert \\ (Nur Spaltennamen)\end{tabular} & \cellcolor[HTML]{9AFF99}\begin{tabular}[c]{@{}c@{}}Datensätze \\ hinzugekommen,\\  keine Artefakte\end{tabular} & \cellcolor[HTML]{9AFF99}\begin{tabular}[c]{@{}c@{}}Datensätze \\ hinzugekommen,\\  keine Artefakte\end{tabular} & \cellcolor[HTML]{FD6864}Datensätze gelöscht                                                                  \\ \hline
...
\subsubsection*{Registry}\label{chap:anhang-chrome-common-registry}
...
\afterpage{
	\begin{landscape}% Landscape page
		...
		\begin{table}[h!]
			%	\centering
			\caption{Brave alle ``WriteFile``-Operationen des Logfiles 1}
...
\afterpage{
	\begin{landscape}% Landscape page
		...
		\begin{table}[h!]
			%	\centering
			\caption{Brave alle ``WriteFile``-Operationen des Logfiles 2}
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		\textbf{Dateiname}       & \textbf{\begin{tabular}[c]{@{}c@{}}Vor Browsing \\ Szenario (S1)\end{tabular}}                      & \textbf{\begin{tabular}[c]{@{}c@{}}Nach Browsing Szenario, \\ Browser geöffnet (S2)\end{tabular}}        & \textbf{\begin{tabular}[c]{@{}c@{}}Nach Browsing Szenario, \\ Browser geschlossen (S3)\end{tabular}}            & \textbf{\begin{tabular}[c]{@{}c@{}}VM \\ heruntergefahren (S4)\end{tabular}}                                    \\ \hline
		History                  & \cellcolor[HTML]{FFCE93}\begin{tabular}[c]{@{}c@{}}Initialisiert \\ (Nur Spaltennamen)\end{tabular} & \cellcolor[HTML]{FE996B}keine Veränderung                                                                & \cellcolor[HTML]{9AFF99}\begin{tabular}[c]{@{}c@{}}Datensätze \\ hinzugekommen,\\  keine Artefakte\end{tabular} & \cellcolor[HTML]{FD6864}Datensatz gelöscht                                                                      \\ \hline
		Web Data                 & \cellcolor[HTML]{FFCE93}\begin{tabular}[c]{@{}c@{}}Initialisiert \\ (Nur Spaltennamen)\end{tabular} & \cellcolor[HTML]{F56B00}\begin{tabular}[c]{@{}c@{}}Inhalte verändert, \\ keine PB Artefakte\end{tabular} & \cellcolor[HTML]{FE996B}\begin{tabular}[c]{@{}c@{}}keine \\ Veränderung\end{tabular}                            & \cellcolor[HTML]{9AFF99}\begin{tabular}[c]{@{}c@{}}Datensätze \\ hinzugekommen,\\  keine Artefakte\end{tabular} \\ \hline
...
\subsubsection*{Registry}\label{chap:anhang-brave-common-locations-registry}

Auch für Brave wurde wieder die Registry-Aktivität beobachtet und analysiert. Hier konnten aber, wie bei Chrome, keine relevanten Informationen aus den RegSet-Operationen extrahiert werden, welche das PB-Szenario betreffen.
