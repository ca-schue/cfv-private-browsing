...
%/ IST TOR Tatsächlich "bester Browser?"
%=> Alle Browser schneiden sehr gut ab 
%=> Meine Meinung: Tor (Dazu kommt Schutz vor Web-Angreifer durch Tor-Netzwerk)
%=> ABER: "User Experience" beim Tor-Browser schlecht (langsam, Seiten stürzen ab, Captchas auf jeder Google Seite etc.)
%
%=> Hier unbedingt Live- und Post-Mortem Analyse ansprechen!
%
%=> Nur in Arbeitsspeicher PB-Artefakte!
%=> Firefox: Nach leeren des Caches und Beenden des DNSCache-Dienstes wurden keine Artefakte mehr im RAM-Dump 3 gefunden.
%

%Zukünftige Arbeiten
%> Andere Browser
%> Mac und Linux
%> Webangreifer analysieren
