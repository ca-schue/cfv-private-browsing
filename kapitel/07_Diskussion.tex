...
Beispielsweise hinterlässt der Tor-Browser zwar weniger E-Mail-Artefakte, speichert jedoch im Gegensatz zu Google Chrome und Brave das Passwort im Klartext. Umgekehrt hinterlässt der Tor-Browser keine HTML-Artefakte.
