...
wodurch der Fokus darauf liegt, das System vollständig zu verstehen und alle potentiellen Beweise zu sammeln. \cite{Bonetti.2014}
...
Dazu wird jedes Logfile mit dem Process Monitor eingelesen. Anschließend werden die Aktivitäten gefiltert.
\begin{figure}[h!]
...
In der Literatur werden der Arbeitsspeicherabbilder oft unzureichend durch eine Stichwortsuche im Hexadezimaleditor analysiert. \cite{Rochmadi.2017, Md.2018, Montasari.2015}
Wie beispielhaft in Abbildung \ref{img:textfile-ram-artifact} gezeigt, wird ein String, der in einer Textdatei auf dem Desktop gespeichert ist, im Hexadezimaleditor HxD angezeigt, obwohl kein Browsing Szenario durchgeführt wurde.
\begin{figure}[h!]
	\centering
...
Zur Analyse wird jeder Hive aus den Fesplatten-Images extrahiert und in eine Registry Explorer Sitzung geladen, um eine eine Stringsuche nach PB Artefakten durchzuführen.
