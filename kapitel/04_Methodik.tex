...
Die Dokumentationsphase entspricht in dieser Arbeit dem Kapitel \ref{chapter:vergleich-der-browser}, \grqq{}Vergleich der Browser\grqq{}. Die Methodik der anderen Phasen wird nachfolgend beschrieben.
...
\begin{figure}[h!]
	...
	\caption{Funktion \grqq{}Neue Identität\grqq{} des Tor-Browsers}
	\label{img:tor-new-identity}
\end{figure}
Die in Abbildung \ref{img:tor-new-identity} gezeigte Funktion \grqq{}\textit{Neue Identität}\grqq{} ermöglicht es, alle aktuellen Tabs und Fenster zu schließen, sämtliche private Informationen wie Cookies und Verlauf zu löschen sowie die Verbindung mit dem Tor-Netzwerk neu zu konfigurieren. \cite{Tor.24.05.2023}
...
Für diesen Versuch wurden ausschließlich Daten definiert, die nicht bereits vor Durchführung des Browsing-Szenarios auf dem Rechner zu finden sind. Beispielsweise sind die Zeichenketten \grqq{}twitter\grqq{} oder \grqq{}facebook\grqq{} bereits in vielen Windows-Standardanwendungen enthalten.
...
\item  www.google.com aufrufen
	...
	\item Google-Suche nach \grqq{}pfaffenhofen\grqq{}
	\end{enumerate}
\item www.google.com aufrufen
	\begin{enumerate}[label*=\arabic*.]
	\item Cookies alle akzeptieren (wenn gefordert)
	\item Google-Suche nach \grqq{}nanoradar\grqq{}
	\end{enumerate}
\item www.google.com aufrufen
	\begin{enumerate}[label*=\arabic*.]
	\item Cookies alle akzeptieren (wenn gefordert)
	\item Google-Suche nach \grqq{}mallofamerica\grqq{}
	\item Auf Suchergebnis \grqq{}mallofamerica.com\grqq{} klicken
	\end{enumerate}
\item www.google.com aufrufen
	\begin{enumerate}[label*=\arabic*.]
	\item Cookies alle akzeptieren (wenn gefordert)
	\item Google-Suche nach \grqq{}mooserliesl\grqq{}
	\item Auf Suchergebnis \grqq{}mooserliesl.de\grqq{} klicken
	\end{enumerate}
\item \grqq{}unitree.com\grqq{} über URL-Leiste öffnen
\item \grqq{}donaukurier.de\grqq{} über URL-Leiste öffnen
	\begin{enumerate}[label*=\arabic*.]
	\item Donaukurier Logo in neuem Tab öffnen
	\end{enumerate}
\item \grqq{}mail.google.com\grqq{} über URL-Leiste öffnen
	\begin{enumerate}[label*=\arabic*.]
	\item Mit google Account anmelden: 
			\begin{enumerate}[label*=\arabic*.]
			\item E-Mail = \grqq{}computerforensikvl@gmail.com\grqq{}
			\item Passwort = \grqq{}Vorlesung23! \grqq{}
			\end{enumerate}
	\item Neue E-Mail schreiben:
			\begin{enumerate}[label*=\arabic*.]
			\item Empfänger: \grqq{}cas0597@thi.de\grqq{} und \grqq{}chs3702@thi.de\grqq{}
			\item Betreff: \grqq{}Betrefftext\grqq{}
			\item Mailinhalt: \grqq{}Mailinhalt\grqq{}
			\end{enumerate}			
	\end{enumerate}
\end{enumerate}
...
\multirow{4}{*}{Suchbegriff} & \grqq{}pfaffenhofen\grqq{}                                                                               & 1.2                                                                              \\ \cline{2-3} 
                             & \grqq{}nanoradar\grqq{}                                                                                  & 2.2                                                                              \\ \cline{2-3} 
                             & \grqq{}mallofamerica\grqq{}                                                                              & 3.2                                                                              \\ \cline{2-3} 
                             & \grqq{}mooserliesl\grqq{}                                                                                & 4.2                                                                              \\ \hline
\multirow{4}{*}{URL}         & \grqq{}mooserliesl.de\grqq{}                                                                             & 3.3                                                                              \\ \cline{2-3} 
                             & \grqq{}mallofamerica.com\grqq{}                                                                          & 4.3                                                                              \\ \cline{2-3} 
                             & \grqq{}unitree.com\grqq{}                                                                                & 5.                                                                               \\ \cline{2-3} 
                             & \grqq{}donaukurier.de\grqq{}                                                                             & 6.                                                                               \\ \hline
Bild                         & \begin{tabular}[c]{@{}l@{}}0x89 0x50 0x4E 0x47 ...\\ (PNG als Hexadezimalwerte)\end{tabular} & 6.1                                                                              \\ \hline
\multirow{4}{*}{E-Mail}      & \grqq{}computerforensikvl@gmail.com\grqq{}                                                               & 7.1.1                                                                            \\ \cline{2-3} 
                             & \grqq{}Vorlesung23! \grqq{}                                                                               & 7.1.2                                                                            \\ \cline{2-3} 
                             & \grqq{}cas0597@thi.de\grqq{}                                                                             & 7.2.1                                                                            \\ \cline{2-3} 
                             & \grqq{}chs3702@thi.de\grqq{}                                                                             & 7.2.1                                                                            \\ \hline
\end{tabular}
\end{table}
...
FirefoxCache2                           & Erweitert MZCacheView, um Firefox \grqq{}index\grqq{}-Cachedatei zu analysieren              & Commit b50ab4f                        \\ \hline
...
Dieses Vorgehen zur Datensammlung wird bei allen Browsern durchgeführt. Einzig der Tor-Browser weicht davon ab. Um die \grqq{}Neue Identität\grqq{}-Funktion des Tor-Browsers zu berücksichten, werden zusätzlich Daten vor und nach der Erstellung einer \grqq{}Neuen Identiät\grqq{} gesammelt. Wie in Abbildung \ref{img:zeitpunkte-datensammlung-tor} dargestellt, umfasst dies einen zusätzlichen RAM-Dump sowie VM-Snapshot und ein weiteres Process Monitor Logfile.
\begin{figure}[h!]
	\centering
	\small
...
Dazu wird jedes Logfile mit dem Process Monitor eingelesen. Anschließend werden die Aktivitäten gefiltert. Wie in Abbildung \ref{img:procmon-writefile-filter} dargestellt, wird dazu ausschließlich die Option \grqq{}File System Activity\grqq{} ausgewählt.
\begin{figure}[h!]
...
\end{itemize}
Da PB-Artefakte nur über Schreiboperationen entstehen können, wird als Prozessoperation \grqq{}WriteFile\grqq{} gesetzt.
...
Im Falle der Datei \grqq{}some-file.json.tmp\grqq{} wird beispielsweise geprüft, ob die Datei \grqq{}some-file.json\grqq{} existiert.
...
Diese Seite kann mithilfe des \grqq{}--dump\grqq{} Flags extrahiert werden: \texttt{vol.py -f ram\_dump.img -o $\backslash$dump\_dir$\backslash$ windows.memmap --pid <PID> -{}-dump}.
...
\end{figure}
Wie in Abbildung \ref{img:procmon-setvalue-filter} gezeigt, wird zunächst das Logfile nach \grqq{}Registry Activity\grqq{} sowie Einträgen mit der Operation \grqq{}SetValue\grqq{} sowie dem Browser-Prozessnamen gefiltert.
