...
%				\legend{firefox.exe, tor.exe, Andere Prozesse}
		...
		\begin{tikzpicture}
			...
			width=12cm, 
			height=3cm, 
			ylabel style={align=center}, ylabel=Mailinhalt,
			y=0.65cm,
			symbolic y coords={RAM-Dump 3-2, RAM-Dump 3-1, RAM-Dump 2, RAM-Dump 1},
			xticklabels={,,},
            xmin = 0,
...
%				\legend{firefox.exe, tor.exe, Andere Prozesse}
		...
		\begin{tikzpicture}
			...
			width=12cm, 
			height=3cm, 
			ylabel style={align=center}, ylabel=Vorlesung23!,
			y=0.65cm,
			symbolic y coords={RAM-Dump 3-2, RAM-Dump 3-1, RAM-Dump 2, RAM-Dump 1},
			xticklabels={,,},
            xmin = 0,
...
%				\legend{firefox.exe, tor.exe, Andere Prozesse}
		...
		\begin{tikzpicture}
			...
			width=12cm, 
			height=3cm, 
			ylabel style={align=center}, ylabel=computerforensikvl\\@gmail.com,
			y=0.65cm,
			symbolic y coords={RAM-Dump 3-2, RAM-Dump 3-1, RAM-Dump 2, RAM-Dump 1},
			xticklabels={,,},
            xmin = 0,
...
Bei Untersuchung des String-Kontexts wurden für das Passwort am Byte-Offset \texttt{0xea0318} wie in Abbildung \ref{img:tor-pw-offset-pid-708-0xea0318} gezeigt keine Auffällige Artefakte entdeckt.
\begin{figure}[h!]
...
\begin{table}[h!]
	...
	\begin{tabular}{r}
		\begin{tikzpicture}
			...
			width=12cm, 
			height=3cm, 
			ylabel style={align=center}, ylabel=RAM-Dump 3-2,
			y=0.9cm,
			symbolic y coords={DK-Logo, E-Mail, URLs, Suchbegriffe},
			ytick=data,
			xticklabels={,,},
			...
			nodes near coords style={font=\tiny},
   			nodes near coords={\pgfmathfloatifflags{\pgfplotspointmeta}{0}{}{\pgfmathprintnumber{\pgfplotspointmeta}}},
			bar width=.2cm,
			enlarge y limits={abs=2.3*\pgfplotbarwidth},
			scaled x ticks=false,
			legend style={
				at={(0.5,-0.1)},
				anchor=north
		...
		\begin{tikzpicture}
			...
			width=12cm, 
			height=3cm, 
			ylabel style={align=center}, ylabel=RAM-Dump 3-1,
			y=0.9cm,
			symbolic y coords={DK-Logo, E-Mail, URLs, Suchbegriffe},
			ytick=data,
			xticklabels={,,},
